...
namespace game4
{
    ...
    template <typename T>
    class Tetris3 : public abstractTetris
    {
        
    private:
        T tetris_board;  // This is my real tetris board for game...
...
template class Tetris3 <vector<char>>;
template class Tetris3 <deque<char>>;
