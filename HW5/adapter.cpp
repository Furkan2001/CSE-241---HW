...
template <typename T>
Tetris3<T> :: Tetris3(){ flag = 0; number_of_moves = 0; }


// This is my constructor...
// row -> coordinate[0]       column -> coordinate[1]
template <typename T>
Tetris3<T> :: Tetris3 (int* coordinate)
{
    int length;
    coordinate[0] += 2;
    coordinate[1] += 2;
    ...
    for (int i = 0; i < length; i++)
        tetris_board.push_back('x');
    coordinate0 = coordinate[0] - 2;  // Normal row
    coordinate1 = coordinate[1] - 2;  // Normal column
    
    for (int i = 0; i < coordinate[0]; i++)  // I filled inside my real tetris board...
    {
...
template <typename T>
int Tetris3<T> :: get_tetro_row() const
{
    return (tetro_row);
}
...
template <typename T>
int Tetris3<T> :: get_tetro_column() const
{
    return (tetro_column);
}
...
template <typename T>
int Tetris3<T> :: numberOfMoves() const
{
...
template <typename T>
void Tetris3<T> :: my_first_main_function(int *coordinate)
{
...
/* This funtion is drawing my tetris board to the screen...*/
template <typename T>
void Tetris3<T> :: Draw() const
{
...
/* This function print to screen board which I read from file... */
template <typename T>
void Tetris3<T> :: Draw_v1() const
{
    for (auto row : v1)
    {
        for (auto col : row)
...
template <typename T>
void Tetris3<T> :: my_second_main_function(Tetromino &tetromino)
{
    char choice;
    int value;
...
template <typename T>
void Tetris3<T> :: operator +=(Tetromino &tetromino)
{
    int location;
...
template <typename T>
void Tetris3<T> :: my_third_main_function(Tetromino &tetromino)
{
...
/* parameters of slide right function are a tetromino object and indexes of highest right side of shape of this tetromino object*/
template <typename T>
void Tetris3<T> :: slide_right(Tetromino &tetromino, int row, int column)
{
...
/* parameters of slide right function are a tetromino object and indexes of highest right side of shape of this tetromino object*/
template <typename T>
bool Tetris3<T> :: are_they_space_right(Tetromino &tetromino, int row, int column)
{
    for (int i = 0; i < tetromino.get_row(); i++)
...
/* parameters of slide bottom function are a tetromino object and indexes of bottomest right side of shape of this tetromino object*/
template <typename T>
void Tetris3<T> :: slide_bottom(Tetromino &tetromino, int row, int column)
{
...
template <typename T>
bool Tetris3<T> :: are_they_space_bottom(Tetromino &tetromino, int row, int column)
{
    int i = 0;
...
/* parameters of slide left function are a tetromino object and indexes of highest left side of shape of this tetromino object*/
template <typename T>
void Tetris3<T> :: slide_left(Tetromino &tetromino, int row, int column)
{
...
/* parameters of slide left function are a tetromino object and indexes of highest left side of shape of this tetromino object*/
template <typename T>
bool Tetris3<T> :: are_they_space_left(Tetromino &tetromino, int row, int column)
{
    for (int i = 0; i < tetromino.get_row(); i++)
        if (tetris_board[((row + i) * (coordinate1 + 2)) + column - 1] != ' ' && tetris_board[((row + i) * (coordinate1 + 2)) + column] != ' ')
            return (0);
...
template <typename T>
MoveActions Tetris3<T> :: lastMove() const
{
    if (flag != 0)
    {
...
template <typename T>
void Tetris3<T> :: equalBoards()  // I equaled my real tetris board and vector which I read from file in here...
{
...
template <typename T>
void Tetris3<T> :: readFromFile(const string file)
{
...
template <typename T>
void Tetris3<T> :: writeToFile(const string file)
{
